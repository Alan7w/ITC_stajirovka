<template>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M21 3V8H16" stroke="#E7000B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path
            ...
            stroke="#E7000B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M8 16H3V21" stroke="#E7000B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
