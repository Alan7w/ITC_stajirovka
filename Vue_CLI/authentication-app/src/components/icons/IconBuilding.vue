<template>
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            ...
            stroke="#155DFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 6H14" stroke="#155DFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 10H14" stroke="#155DFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 14H14" stroke="#155DFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 18H14" stroke="#155DFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
